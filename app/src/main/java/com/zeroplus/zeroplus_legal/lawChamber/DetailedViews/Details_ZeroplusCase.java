...
public class Details_ZeroplusCase extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_details_zeroplus_case);
        ...
        toolbarTextView.setText("Zeroplus Case Details");

        backBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(Details_ZeroplusCase.this, zpCases.class);
                startActivity(i);
                // close this activity
                finish();
            }
