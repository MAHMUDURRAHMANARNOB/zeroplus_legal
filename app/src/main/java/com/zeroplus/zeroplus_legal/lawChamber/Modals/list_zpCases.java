...
public class list_zpCases {

    private String FileName, CaseNo, FileNo, FilingDate, CaseStatus, JudgementStatus, Position;

    public list_zpCases(String fileName, String caseNo, String fileNo, String filingDate, String caseStatus, String judgementStatus, String position) {
        FileName = fileName;
        CaseNo = caseNo;
        FileNo = fileNo;
